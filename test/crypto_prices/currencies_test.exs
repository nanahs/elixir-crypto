defmodule Crypto.CurrenciesTest do
  ...
  describe "currencies" do
    ...
    test "create_currency/1 with valid data creates a currency" do
      valid_attrs = %{current_price: "120.5", name: "some name", priced_at: ~N[2021-09-17 01:39:00]}
    ...
    test "update_currency/2 with valid data updates the currency" do
      currency = currency_fixture()
      update_attrs = %{current_price: "456.7", name: "some updated name", priced_at: ~N[2021-09-18 01:39:00]}
